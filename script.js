...
// to start serach when enter key is pressed
...
async function fetchVideo(queryitem) {
    ...
    for (let i = 0; i < res1.items.length; i++) {
        ...
        <div class="card-body">
          ...
          <a href="https://www.youtube.com/watch?v=${res1.items[i].id.videoId}" class="btn btn-danger col-xl-5 p-1"><i class="fa-solid fa-play text-dark"></i> watch</a>
...
async function vd1(arr) {
    ...
    for (let index = 0; index < arr.length; index++) {
        ...
        vd.addEventListener("click", () => {
            ...
            // to handle undefined error in the publishedAt value
